...
You do not actually need a controller / gpio pins to play this game, you are allowed to pause the game if you have the controller / gpio pins.
If you have a controller / pins, i'd reccomend you check out the "jump game" that I made that's also for the RPI2!
